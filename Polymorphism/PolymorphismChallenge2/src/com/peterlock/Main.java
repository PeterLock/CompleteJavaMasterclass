...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        hamburger.addAddition1("Cheese", 0.27);
        hamburger.addAddition2("Tomato", 1.45);
        hamburger.addAddition3("Bacon", 1.12);
        hamburger.addAddition4("Lettuce", 1.13);
        System.out.println("Total burger price comes to: " + hamburger.itemizeHamburger());
        ...
        db.itemizeHamburger();
        db.addAddition1("Should not be able to do this", 1.20);
    }
}
